...
bool func (string**Q, int n){
	...
	for(int i=0; i<max.length(); i++){
		if(max[i] == 'a'|| max[i] == 'e'||max[i] == 'i'|| max[i] == 'o'|| max[i] == 'u' || max[i] == 'A'|| max[i] == 'E'||max[i] == 'I'|| max[i] == 'O'|| max[i] == 'U'){
			countmax++;
		}
	}
	
	for(int i=0; i<min.length(); i++){
		if(min[i] == 'a'|| min[i] == 'e'||min[i] == 'i'|| min[i] == 'o'|| min[i] == 'u'|| max[i] == 'A'|| max[i] == 'E'||max[i] == 'I'|| max[i] == 'O'|| max[i] == 'U'){
			countmin++;
		}
	}
